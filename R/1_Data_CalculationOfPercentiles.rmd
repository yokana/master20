...
**COMMENT**: In comparision to version 1 and 2 percentiles were calculated without a reference group. 
...
main_data <- 
  main_data %>% mutate(perc_maths_gk=percent_rank(gktmathss), perc_read_gk =percent_rank(gktreadss), perc_word_gk=percent_rank(gkwordskillss), perc_av_gk=percent_rank(gkaversc))
...
```{r echo=TRUE}
save(main_data, file = "/home/johannes/Documents/Projects/2020_Master_STAR/master20/data/main_data_new.RData")    
```
